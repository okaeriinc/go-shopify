...
type Order struct {
	...
	DiscountApplications  []OrderDiscountApplication `json:"discount_applications,omitempty"`
...
type OrderDiscountApplication struct {
	Type             string `json:"type,omitempty"`              // eg: "discount_code"
	Value            string `json:"value,omitempty"`             // eg: "10.0"
	ValueType        string `json:"value_type,omitempty"`        // eg: "percentage"
	AllocationMethod string `json:"allocation_method,omitempty"` // eg: "across"
	TargetSelection  string `json:"target_selection,omitempty"`  // eg: "all"
	TargetType       string `json:"target_type,omitempty"`       // eg: "target_type"
	Code             string `json:"code,omitempty"`              // eg: "G8BGN4"
}
